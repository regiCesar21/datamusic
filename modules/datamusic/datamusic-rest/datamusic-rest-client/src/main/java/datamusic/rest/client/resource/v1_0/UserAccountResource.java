...
public interface UserAccountResource {
	...
	public void deleteUserAccountById(Integer userAccountId) throws Exception;

	public HttpInvoker.HttpResponse deleteUserAccountByIdHttpResponse(
	...
	public HttpInvoker.HttpResponse getUserAccountIdByIdHttpResponse(
			Integer userAccountId)
		throws Exception;
	...
	public static class UserAccountResourceImpl implements UserAccountResource {
		...
		public HttpInvoker.HttpResponse getUserAccountHttpResponse()
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/datamusic-rest/v1.0/userAccount");
		...
		public HttpInvoker.HttpResponse postUserAccountBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/datamusic-rest/v1.0/userAccount/batch");
		...
		public void deleteUserAccountById(Integer userAccountId)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteUserAccountByIdHttpResponse(userAccountId);
		...
		public HttpInvoker.HttpResponse deleteUserAccountByIdHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/datamusic-rest/v1.0/userAccount/delete-UserAccount/{userAccountId}");
		...
		public UserAccount getUserAccountIdById(Integer userAccountId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getUserAccountIdByIdHttpResponse(userAccountId);
		...
		public HttpInvoker.HttpResponse getUserAccountIdByIdHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/datamusic-rest/v1.0/userAccount/userAccount-by-id/{userAccountId}");
