...
/**
 * Provides the local service interface for Media. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Regisson Aguiar
 * @see MediaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MediaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.datamusic.app.service.impl.MediaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the media local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MediaLocalServiceUtil} if injection and service tracking are not available.
	 */
