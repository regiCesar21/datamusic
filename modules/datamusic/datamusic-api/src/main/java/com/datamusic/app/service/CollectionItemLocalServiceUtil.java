...
/**
 * Provides the local service utility for CollectionItem. This utility wraps
 * <code>com.datamusic.app.service.impl.CollectionItemLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CollectionItemLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.datamusic.app.service.impl.CollectionItemLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CollectionItem addCollectionItem(
		CollectionItem collectionItem) {

		return getService().addCollectionItem(collectionItem);
	}
	 ...
	 */
	public static CollectionItem createCollectionItem(long collectionItemId) {
		return getService().createCollectionItem(collectionItemId);
	}
	 ...
	 */
	public static CollectionItem deleteCollectionItem(
		CollectionItem collectionItem) {

		return getService().deleteCollectionItem(collectionItem);
	}
	 ...
	 */
	public static CollectionItem deleteCollectionItem(long collectionItemId)
		throws PortalException {

		return getService().deleteCollectionItem(collectionItemId);
	}
	...
	public static CollectionItem fetchCollectionItem(long collectionItemId) {
		return getService().fetchCollectionItem(collectionItemId);
	}
	 ...
	 */
	public static CollectionItem fetchCollectionItemByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().fetchCollectionItemByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 * @throws PortalException if a collection item with the primary key could not be found
	 */
	public static CollectionItem getCollectionItem(long collectionItemId)
		throws PortalException {

		return getService().getCollectionItem(collectionItemId);
	}
	 ...
	 */
	public static CollectionItem getCollectionItemByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return getService().getCollectionItemByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static List<CollectionItem> getCollectionItems(int start, int end) {
		return getService().getCollectionItems(start, end);
	}
	 ...
	 */
	public static int getCollectionItemsCount() {
		return getService().getCollectionItemsCount();
	}
	 ...
	 */
	public static CollectionItem updateCollectionItem(
		CollectionItem collectionItem) {

		return getService().updateCollectionItem(collectionItem);
	}

	public static CollectionItemLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CollectionItemLocalService> _serviceSnapshot =
		new Snapshot<>(
			CollectionItemLocalServiceUtil.class,
			CollectionItemLocalService.class);
